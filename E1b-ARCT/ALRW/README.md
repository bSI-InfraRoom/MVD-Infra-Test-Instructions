...
|----------------------|------------------------------------------------|---------------|-----------| ----------------|------------|---------|------------|
| IFC4.3AbRV_E1b_ALRW   | Alignment Railway Curves                      | E1b-ARCT      | ALRW      |                 |            | 1.0     | DD.MM.YYYY |
...
This test instruction is defined for IFC4.3AbRV_E1b_ALRW Alignment Railway Curves.
It covers the following subjects:
- Project setup including units and context
- A set of aligments including horizontal, vertical and cant layouts
- Alignment horizontal segments including line segments, circular arc segments, clothoid segments, cubic segments, helmert curve segments, bloss curve segments, viennese bend segments, sine curve segments and cosine curve segments.
- Alignment vertical segments including constant gradiant segments, circular arc segments and clothoid segments
- Alignment cant segments including constant cant segments, linear transition segments, and segments for high performance transtions including bloss curve, cosinecurve, helmertcurve, sine curve and viennes bend.
...
- Test Case Specific Concept Templates
  - *Alignment Layout*
  - *Alignment Cant Geometry*
  - *Alignment Gradient Geometry*
  - *Arc Segment*
  - *Bloss Transition Segment*
  - *Clothoid Transition Segment*
  - *Cosine Transition Segment*
  - *Cubic Transition Segment*
  - *Helmert Transiton Segment*
  - *Linear Segment*
  - *Sine Transition Segment*
  - *Vinnese Bend Transition Segment*
