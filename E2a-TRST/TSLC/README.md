...
|----------------------|------------------------------------------------|---------------|-----------| ----------------|------------|---------|------------|
| IFC4.3AbRV_E2a_TSLC   | Track Structures Level Crossing               | E2a-TRST      | TSLC      |                 | FTIA?      | 1.0     | DD.MM.YYYY |
...
This test case is defined for IFC4.3 AbRV_E2a_TSLC Track Structures Level Crossing.
